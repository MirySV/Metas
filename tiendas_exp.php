                        ...
                        <table class="tabla_texp">
                            ...
                            <tr>
                                ...
                                if (isset($_POST['inicio']) && isset($_POST['fin'])) {
                                    ...
                                    $tiendas_explanada = mysqli_query($conec, "SELECT fecha, grupos, pax, visitantes FROM tiendas_explanada WHERE fecha BETWEEN '$fechainicio' AND '$fechafin' ORDER BY fecha DESC ");
                                } else {
                                    $tiendas_explanada = mysqli_query($conec, "SELECT fecha, grupos, pax, visitantes FROM tiendas_explanada ORDER BY fecha DESC");
                                }
